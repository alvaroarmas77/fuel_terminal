...
class OutlookCalendarTool(BaseTool):
    ...
    def _run(self, requested_datetime: str, plate_id: str) -> str:
        ...
        try:
            ...
            # Generamos los nombres exactos: Terminal_Isla_1, Terminal_Isla_2...
            ...
            for island_name in islands:
                try:
                    ...
                    # Verificamos si hay eventos en ese rango
                    ...
                    continue # Si una isla no existe o no es accesible, probamos la siguiente
